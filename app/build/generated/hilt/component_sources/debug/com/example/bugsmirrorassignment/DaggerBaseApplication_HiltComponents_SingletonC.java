...
import com.example.bugsmirrorassignment.room.dao.UserDaoModule;
import com.example.bugsmirrorassignment.room.dao.UserDaoModule_ProvidesUserDatabaseFactory;
import com.example.bugsmirrorassignment.room.database.UserDatabase;
import com.example.bugsmirrorassignment.viewModel.MainViewModel;
import com.example.bugsmirrorassignment.viewModel.MainViewModel_HiltModules;
import com.example.bugsmirrorassignment.viewModel.MainViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.example.bugsmirrorassignment.viewModel.MainViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
...
public final class DaggerBaseApplication_HiltComponents_SingletonC {
  ...
  public static final class Builder {
    ...
    private UserDaoModule userDaoModule;
    ...
    public Builder userDaoModule(UserDaoModule userDaoModule) {
      this.userDaoModule = Preconditions.checkNotNull(userDaoModule);
      return this;
    }

    public BaseApplication_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      if (userDaoModule == null) {
        this.userDaoModule = new UserDaoModule();
      }
      return new SingletonCImpl(applicationContextModule, userDaoModule);
    }
  }
  ...
  private static final class ViewModelCImpl extends BaseApplication_HiltComponents.ViewModelC {
    ...
    UserRepository userRepository() {
      return new UserRepository(singletonCImpl.providesUserDatabaseProvider.get());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.bugsmirrorassignment.viewModel.MainViewModel
          return (T) new MainViewModel(viewModelCImpl.userRepository());
  ...
  private static final class SingletonCImpl extends BaseApplication_HiltComponents.SingletonC {
    private final UserDaoModule userDaoModule;

    private final ApplicationContextModule applicationContextModule;

    private final SingletonCImpl singletonCImpl = this;

    Provider<UserDatabase> providesUserDatabaseProvider;

    SingletonCImpl(ApplicationContextModule applicationContextModuleParam,
        UserDaoModule userDaoModuleParam) {
      this.userDaoModule = userDaoModuleParam;
      this.applicationContextModule = applicationContextModuleParam;
      initialize(applicationContextModuleParam, userDaoModuleParam);

    }

    @SuppressWarnings("unchecked")
    private void initialize(final ApplicationContextModule applicationContextModuleParam,
        final UserDaoModule userDaoModuleParam) {
      this.providesUserDatabaseProvider = DoubleCheck.provider(new SwitchingProvider<UserDatabase>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.bugsmirrorassignment.room.database.UserDatabase
          return (T) UserDaoModule_ProvidesUserDatabaseFactory.providesUserDatabase(singletonCImpl.userDaoModule, ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
